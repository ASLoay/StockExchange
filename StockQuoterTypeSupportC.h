...
#ifndef _TAO_IDL_STOCKQUOTERTYPESUPPORTC_CBPUI7_H_
#define _TAO_IDL_STOCKQUOTERTYPESUPPORTC_CBPUI7_H_
...
#define _STOCKQUOTER_EXCHANGEEVENTTYPESUPPORT__TRAITS_
  ...
  template<>
  struct  Objref_Traits< ::StockQuoter::ExchangeEventTypeSupport>
  {
...
#define _STOCKQUOTER_EXCHANGEEVENTDATAWRITER__TRAITS_
  ...
  template<>
  struct  Objref_Traits< ::StockQuoter::ExchangeEventDataWriter>
  {
...
#define _STOCKQUOTER_EXCHANGEEVENTDATAREADER__TRAITS_
  ...
  template<>
  struct  Objref_Traits< ::StockQuoter::ExchangeEventDataReader>
  {
